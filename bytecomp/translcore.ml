...
let comparisons_table = create_hashtable 11 [
  "%equal",
      (Pccall{prim_name = "caml_equal"; prim_arity = 2; 
              prim_alloc = true; prim_ctx = false; (* phc todo *)
              prim_native_name = ""; prim_native_float = false},
       Pintcomp Ceq,
       Pfloatcomp Ceq,
       Pccall{prim_name = "caml_string_equal"; prim_arity = 2;
              prim_alloc = false; prim_ctx = false; (* phc non-reentrant *)
              prim_native_name = ""; prim_native_float = false},
       ...
       true);
  "%notequal",
      (Pccall{prim_name = "caml_notequal"; prim_arity = 2; 
              prim_alloc = true; prim_ctx = false; (* phc todo *)
              prim_native_name = ""; prim_native_float = false},
       Pintcomp Cneq,
       Pfloatcomp Cneq,
       ...
       true);
  "%lessthan",
      (Pccall{prim_name = "caml_lessthan"; prim_arity = 2; 
              prim_alloc = true; prim_ctx = false; (* phc todo *)
              prim_native_name = ""; prim_native_float = false},
       Pintcomp Clt,
       Pfloatcomp Clt,
       ...
       false);
  "%greaterthan",
      (Pccall{prim_name = "caml_greaterthan"; prim_arity = 2; 
              prim_alloc = true; prim_ctx = false; (* phc todo *)
              prim_native_name = ""; prim_native_float = false},
       Pintcomp Cgt,
       Pfloatcomp Cgt,
       Pccall{prim_name = "caml_string_greaterthan"; prim_arity = 2;
              prim_alloc = false; prim_ctx = false; (* phc reentrant *)
              prim_native_name = ""; prim_native_float = false},
       ...
       false);
  "%lessequal",
      (Pccall{prim_name = "caml_lessequal"; prim_arity = 2; 
              prim_alloc = true; prim_ctx = false; (* phc todo *)
              prim_native_name = ""; prim_native_float = false},
       Pintcomp Cle,
       Pfloatcomp Cle,
       Pccall{prim_name = "caml_string_lessequal"; 
              prim_arity = 2; 
              prim_alloc = false; prim_ctx = false; (* phc non-reentrant *)
              prim_native_name = ""; prim_native_float = false},
  ...
  "%greaterequal",
      (Pccall{prim_name = "caml_greaterequal"; prim_arity = 2;
       ...
       false);
  "%compare",
      (Pccall{prim_name = "caml_compare"; prim_arity = 2; 
              prim_alloc = true; prim_ctx = false; (* phc todo reentrant *)
              prim_native_name = ""; prim_native_float = false},
...
let prim_obj_dup =
  { prim_name = "caml_obj_dup"; prim_arity = 1; 
    prim_alloc = true; prim_ctx = false; (* phc todo reentrant *)
    prim_native_name = ""; prim_native_float = false }
